...
NEXT_SAFE_ACTION:
Inspect iced 0.14.0 APIs, then implement G7 in bounded local slices: source/profile/state wiring, responsive RTL/theme layout, and keyboard/testability qualification.
