...
G8_NATIVE_QUALIFICATION: IN_PROGRESS
...
NEXT_SAFE_ACTION:
Inventory G8 reusable evidence and missing validity predicates, run only missing local/native qualification, then push one qualified v3 candidate for required remote Windows/macOS/Rust Policy validation.
