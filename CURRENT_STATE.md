...
G6_UI_DESIGN_SYSTEM: IN_PROGRESS
...
NEXT_SAFE_ACTION:
Read the frozen Foundation UI contracts, then implement and qualify the bounded G6 Rust UI design-system foundation while preserving the current v2 main screen until G7.
