...
STATUS: IN_PROGRESS
PHASE: G7R_B_GITHUB_REPOSITORY_RENAME
...
G7R_B_GITHUB_REPOSITORY_RENAME: IN_PROGRESS
...
NEXT_SAFE_ACTION:
Fresh-read GitHub repository/main/open PRs, then rename to KaspaPulse/media-studio, update local origin, and verify redirects/v2.0.0 history before any push.
